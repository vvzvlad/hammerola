...
- [ ] **Хранение исходников по ревизиям.** Решено 2026-08-26: раз хаб
      ...
      **Git рассмотрен и отложен, чтобы не возвращаться.** Из трёх реализаций
      ...
      адресуется. Git окупается на другой задаче — `git clone` из хаба, история,
      диффы исходника для шага 8, — то есть тогда, когда форж действительно
      поедет внутрь. Тогда и только тогда `dulwich`.
