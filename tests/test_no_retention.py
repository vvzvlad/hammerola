"""Nothing is ever deleted for being old or for being one too many (SPEC 5.3, 7.3).
...
publishes a handful of builds and would pass unchanged with a window of twenty
quietly put back; the numbers below are deliberately past the ceilings that used
to exist (20 builds, 200 jobs), so a reintroduced window fails here rather than
in production a month later, on somebody's oldest revision.
"""
