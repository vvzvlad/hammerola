...
Проверено чтением кода, а не по документации: онлайн-документация библиотеки
местами коду не соответствует. Источник истины — исходники форка библиотеки в
...
комментарием «needs a backend we do not run (SPEC 2.4)» — **это устарело**. В библиотеке есть
